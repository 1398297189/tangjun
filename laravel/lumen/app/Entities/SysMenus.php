...
class SysMenus extends Model
{
    ...
    public function getMenusList(){
        return  $thisBuilder = $this->where('moduleid','=','msc')->with('SysPermissionMenu')->get();
    }

    public function getMenusListNotSupremo(){
        return  $thisBuilder = $this->where('moduleid','=','msc')->where('pid','!=',0)->with('SysPermissionMenu')->get();
    }
